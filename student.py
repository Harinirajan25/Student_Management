...
listStd = ["Akash", "Harini", "Raj Kumar", "Swetha","Gunesh"] #List Of Students
...
def manageStudent(): 
	...
	y = "=" * 28
	global bye 
	bye = "G0od Bye!!!  Have A Nice Day".format(x, y, y, x) # Will Print GoodBye Message
  ...
  ------------------------------------------------------
 |======================================================| 
 |======== Welcome To AH Student Management ============|
 |======================================================|
  ------------------------------------------------------
